...
function CardDisplay({ card, questionIndex, round }: Props) {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-surface-card border border-white/5
      ...
      <div className="p-6 space-y-4">
        <div className="flex justify-between items-start">
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg
                           bg-brand/10 text-brand-light text-xs font-semibold uppercase tracking-wider">
            <Hash size={12} />
            {card.theme}
          </span>
